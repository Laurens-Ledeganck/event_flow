...
# from models.model_util import copy_states, CropParameters
# from loss.flow import BaseValidationLoss
# from dataloader.h5 import H5Loader, Frames, ProgressBar, FlowMaps
# import h5py
...
class FullRotationModel(BaseModel):
    ...
    def transfer_hook(self, module, input, output):
        ...
        # TODO: had to remove the index [0] for output when switching to last layer, weird
...
#             r = Rotation.from_quat(np.mean(r, axis=0)) * Rotation.from_quat(file.attrs["gt0"][4:]).inv()

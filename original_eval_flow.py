# Note: adjusted relative imports & paths
...
from event_flow_pipeline.loss.flow import FWL, RSAT, AEE
...
from event_flow_pipeline.utils.iwe import compute_pol_iwe
from event_flow_pipeline.utils.utils import load_model, create_model_dir
from event_flow_pipeline.utils.mlflow import log_config, log_results
from event_flow_pipeline.utils.visualization import Visualization, vis_activity
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path_results", default="results/results_inference/")
    parser.add_argument(
        "--debug",
        action="store_true",
